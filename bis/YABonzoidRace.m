...
- (id) initInWorld: (YARenderLoop*) world PlayerId: (int) id
{
    ...
    if(self) {
        ...
        int raceId = [_world createImpersonatorWithShapeShifter: @"Bonzoid"];
        ...
        mover = [[YABonzoidMover alloc] initWithImp:impersonator inWorld:_world];
        ...
        YAVector3f* cylinder = [[YAVector3f alloc]initVals:7.487 :10.689 :12.089];
        [cylinder mulScalar:0.5f];
        [impersonator setCylinderHalfExtents:cylinder];
        
        YAVector3f* offset = [[YAVector3f alloc]initVals:0.59379 :6.04616 :0];
